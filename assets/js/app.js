...
//   const imageContainer = document.getElementById("wadahgambar");
//   const imageupdate = document.getElementById("updategambar");
//   const apiUrl = "http://192.168.83.17/royal_pro/index.php/Pad/get_mr?norm="+norm;
...
//       //  window.parent.caches.delete("http://192.168.83.17/royal_pro/ttd_pasien/" + norm +".png"); 
// // Make a GET request
...
//         .then(data => {
//           console.log(data);
//           if(data.data.status == 00 || data.data.status == "")
//           {
//             imageContainer.innerHTML = "Norm:"+ data.data.norm+"<br>"+data.data.message;  
//           }else
//           {             
//             imageupdate.innerHTML = "Norm:"+data.data.norm+'<br><img style="width:300;height:300;" src="'+data.data.message+'" />';        
//           }
//         })
//         .catch(error => {
...
//   findButton.addEventListener("blur", () => {

//       cache.delete("/royal_pro/assets/js/app.js");
...
function stateChanged(){
  ...
  if(Ajax.readyState== 4){
    ...
    {         
        if (data.length>0) {
          imageupdate.innerHTML = "Norm:"+myjson.data.norm+'<br><img style="width:300;height:300;" src="'+myjson.data.message+'" />';;
        } else
        {
          imageContainer.innerHTML = " ";
        }
